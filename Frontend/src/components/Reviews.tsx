      ...
      <section className="container mx-auto mb-8 mt-12" id="review">
        ...
        className="flex flex-col">
            ...
            className="flex items-center justify-center gap-6">
                <img src={jane} width={80} height={80} alt={REVIEW.name} 
        ...
        md:flex-row">
            {[customer1, customer2, customer3, customer4].map((customer, index) => (
                <motion.img 
                variants={itemVariants}
                key={index} src={customer} alt="customer" className="h-
                [300px] w-[200px] rounded-br-3xl rounded-tl-3xl object-cover" />
            ))}
        </motion.div>
      </section>
    </div>
